...
# XPU: torchao >= 0.18 缺 Int8Tensor.view / Float8Tensor.abs 等算子注册，
# 这里自动加载补丁（低版本自动跳过，见 fix_torchao_018_xpu.py）
try:
    import fix_torchao_018_xpu
    fix_torchao_018_xpu.patch_torchao_018_xpu()
except Exception:
    pass
