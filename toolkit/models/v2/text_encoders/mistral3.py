...
# note: reformatted from the upstream single-line declaration because GitHub's
# secret scanner false-positives on it ("Mistral AI API Key")
class Mistral3TextEncoder(
        Mistral3ForConditionalGeneration, OstrisTransformersMixin
):
