...
class Krea2Model(BaseModel):
    ...
    def _load_transformer(self):
        ...
        # ComfyUI-format checkpoints (e.g. krea-2-raw-bf16.safetensors from
        # ComfyUI) can carry extra keys the reference architecture does not use
        # (e.g. last.down.weight / last.up.weight). All model keys are present,
        # so ignore the extras instead of failing the load.
