  ...
  return (
    <div className="bg-gray-900 rounded-xl shadow-lg overflow-hidden border border-gray-800">
      <div className="bg-gray-800 px-4 py-3 flex items-center justify-between">
        ...
        {gpu.driverVersion?.startsWith('torch') && (
          <span className="text-xs text-gray-400" title="安装 Intel XPU Manager（xpu-smi）后才有温度/功耗/频率">
            xpu-smi 未安装
          </span>
        )}
      </div>
      ...
      <div className="p-4 space-y-4">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="space-y-2">
            ...
            {/* 风扇转速整行去掉：这张卡上 Level Zero Sysman 报
                numSpeedSensors=0（RPM 查询返回 NOT_APPLICABLE），xpu-smi 的
                指标表里也没有风扇项，没有可靠数据源就不显示。 */}
          </div>
          <div>
